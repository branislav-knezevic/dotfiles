...
source ~/.dotfiles/vim/general/key-mappings.vim
source ~/.dotfiles/vim/general/appearance.vim
source ~/.dotfiles/vim/vim-plug/plugins.vim

" Themes
source ~/.dotfiles/vim/themes/theme.vim
